...
namespace DistributedDesktop.DomainModel
{
	...
	{
		[DataMember(Order = 4)] public double Height;
		[DataMember(Order = 5)] public WindowState State;
		[DataMember(Order = 1)] public double Left;
		[DataMember(Order = 2)] public double Top;
		[DataMember(Order = 3)] public double Width;
